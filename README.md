...
치료 시스템은 환자 중심의 순환적 개선 과정을 통해 작동합니다. 아래 애니메이션은 이명 치료의 핵심 프로세스를 보여줍니다:

<p align="center">
  <img src="docs/images/treatment_workflow.svg" alt="이명 치료 워크플로우" width="800"/>
</p>

환자의 생체신호를 분석하여 개인화된 복합 자극을 생성하고, 이를 특수 장치를 통해 전달합니다. 강화학습 기반 적응형 제어 시스템은 환자의 반응을 지속적으로 모니터링하고 최적의 치료 효과를 위해 자극 패턴을 조정합니다. 이 순환적 과정을 통해 시간이 지남에 따라 치료 효과가 극대화됩니다.
